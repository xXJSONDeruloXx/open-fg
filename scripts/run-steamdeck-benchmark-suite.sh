...
run_preset_reproject_disocclusion() {
  add_case reproject-blend-default OMFG_LAYER_MODE=reproject-blend OMFG_REPROJECT_SEARCH_RADIUS=2 OMFG_REPROJECT_PATCH_RADIUS=1 OMFG_REPROJECT_CONFIDENCE_SCALE=4.0
  add_case reproject-blend-no-current-bias OMFG_LAYER_MODE=reproject-blend OMFG_REPROJECT_SEARCH_RADIUS=2 OMFG_REPROJECT_PATCH_RADIUS=1 OMFG_REPROJECT_CONFIDENCE_SCALE=4.0 OMFG_REPROJECT_DISOCCLUSION_CURRENT_BIAS=0.0
  add_case reproject-multi-count3-default OMFG_LAYER_MODE=reproject-multi-blend OMFG_MULTI_BLEND_COUNT=3 OMFG_REPROJECT_SEARCH_RADIUS=2 OMFG_REPROJECT_PATCH_RADIUS=1 OMFG_REPROJECT_CONFIDENCE_SCALE=4.0
  add_case reproject-multi-count3-no-current-bias OMFG_LAYER_MODE=reproject-multi-blend OMFG_MULTI_BLEND_COUNT=3 OMFG_REPROJECT_SEARCH_RADIUS=2 OMFG_REPROJECT_PATCH_RADIUS=1 OMFG_REPROJECT_CONFIDENCE_SCALE=4.0 OMFG_REPROJECT_DISOCCLUSION_CURRENT_BIAS=0.0
  add_case reproject-adaptive-multi-target180-default OMFG_LAYER_MODE=reproject-adaptive-multi-blend OMFG_ADAPTIVE_MULTI_TARGET_FPS=180 OMFG_ADAPTIVE_MULTI_MIN_GENERATED_FRAMES=0 OMFG_ADAPTIVE_MULTI_MAX_GENERATED_FRAMES=2 OMFG_REPROJECT_SEARCH_RADIUS=2 OMFG_REPROJECT_PATCH_RADIUS=1 OMFG_REPROJECT_CONFIDENCE_SCALE=4.0
  add_case reproject-adaptive-multi-target180-no-current-bias OMFG_LAYER_MODE=reproject-adaptive-multi-blend OMFG_ADAPTIVE_MULTI_TARGET_FPS=180 OMFG_ADAPTIVE_MULTI_MIN_GENERATED_FRAMES=0 OMFG_ADAPTIVE_MULTI_MAX_GENERATED_FRAMES=2 OMFG_REPROJECT_SEARCH_RADIUS=2 OMFG_REPROJECT_PATCH_RADIUS=1 OMFG_REPROJECT_CONFIDENCE_SCALE=4.0 OMFG_REPROJECT_DISOCCLUSION_CURRENT_BIAS=0.0
}
