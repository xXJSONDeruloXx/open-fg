...
modes=(passthrough clear copy history-copy blend adaptive-blend search-blend search-adaptive-blend reproject-blend reproject-adaptive-blend optflow-blend optflow-adaptive-blend optflow-multi-blend optflow-adaptive-multi-blend multi-blend adaptive-multi-blend reproject-multi-blend reproject-adaptive-multi-blend)
if [[ "${OMFG_LAYER_IMPL}" == "rust" ]]; then
  modes+=(bfi)
fi
