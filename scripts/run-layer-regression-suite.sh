...
for mode in passthrough clear copy history-copy blend adaptive-blend search-blend search-adaptive-blend reproject-blend reproject-adaptive-blend multi-blend adaptive-multi-blend; do
